...
public class NaverNewsManager {
    ...
    public static List<NewsVO> newsSearchData(String fd) {
        ...
        String clientId = "P2UB_0pMgaAgrEjtkDCE"; //애플리케이션 클라이언트 아이디
        String clientSecret = "qur3gSDRti"; //애플리케이션 클라이언트 시크릿
...
//        System.out.println(responseBody);
        //  {} -> JSONObject
        //  [] -> JSONArray
        // JSON : 자바스크립트의 객체 표현법 {"key": 값 ...} -> key : value map
        // 호환성이 좋다 => 모바일 , 브라우저에 데이터 묶어서 전송
