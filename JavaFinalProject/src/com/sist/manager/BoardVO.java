...
/*
 *   클래스
 *     = 데이터만 관리 class -> 한개의 대한 정보를 모아서 처리
 ...
 *        Value Object
 *        => 데이터 보호 목적 : 변경이 불가능하게 막아주는 역할 
 *           ----------- 캡슐화
 *                       데이터는 은닉화 하고 메소드를 통해 접근
 *                       -------------   -------------
 ...
 *           ---------------------------- 인터페이스
 *            추상 -> 공통적인 
 *            -> 인터페이스 한개로 관련된 여러 개 클래스를 제어
 *     => 견고한 프로그램을 제적 (에러 -> 복구)
 *       -> 사용자 에러 / 프로그램 에러 -> 복구 (에러를 피해서 다름 문장으로 이동)
 *       -> 예외처리 
