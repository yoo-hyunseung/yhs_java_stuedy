 ...
 *     --------   ObjectInputStream / ObejctOutputStream
...
public class Object_inputOutput_1 {
	...
	public static void main(String[] args)throws Exception {
		...
		list.add(new Sawon(3,"심청이","기획부","사원",3000));
		list.add(new Sawon(4,"이순신","자재부","부장",6500));
		list.add(new Sawon(5,"강감찬","총부무","대리",4500));
		FileOutputStream fos = new FileOutputStream("/Users/yuhyeonseung/Desktop/sist/java_datas/sawon.txt");
