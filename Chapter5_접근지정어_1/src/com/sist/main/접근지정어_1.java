 ...
 *     1. 접근지정어의 종류
 *     --------------------------------------------------------------------------
 *        클래스내에서만 사용   같은 패키지에서 사용   같은 패키지에서 사용     모든 클래스에서 접근
 *        (자신의)                            상속을 받은 클래스는 
 *                                          다음 패키지상에서 접근 
 *     --------------------------------------------------------------------------
 *     private    O             X                 X                    X
...
class Student {
	 ...
	 *   class Human{
	 *      String name; // 멤버변수=>클래스영역(클래스 전체에서 사용)
	 *                       다른 클래스에서도 사용이 가능     
	 *                       Heap 메모리에 저장  스택메모리와 다른 공간이라 같은 이름 가능
	 *      public void setName(String name){
	 *                          -----------  매개 변수
	 *          int a = 10; // 지역변수  ===> stack 메모리에 저장
...
public class 접근지정어_1 {
	...
	public static void main(String[] args) {
		...
		hong.setEng(90);
		hong.setMath(88);
		System.out.println(hong.getHakbun()+" "+hong.getName()+" "+hong.getKor()
		+" "+hong.getEng()+" "+hong.getMath());
		/*
		 *    캡슐화를 사용하는 이유
